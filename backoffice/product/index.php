      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Mantenedor de Productos</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="/Desarrollo-Web-Y-Movil">Backoffice</a></li>
            ...
            <form action="./add/" method="post">
                <div class="modal-body">
                        <div class="form-floating mb-3">
                            ...
                            <label for="email">Número (#) del producto</label>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="lastname" name="apellido" placeholder="Apellido">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="password2">Descripción (corta)</label>
                        </div>
                    ...
                    <label for="rol">Seleccione una categoría para el producto</label>
                    </div>
                    </div>
